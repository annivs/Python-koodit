...
def query_landcode(
        user_input):  # Kysely maakoodista, onko tietyssä maassa tiettyjä lentokenttätyyppejä.
...
while True:  # Kysytään käyttäjältä maakoodia ja tarkistetaan onko olemassa.
